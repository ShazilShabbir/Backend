...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, updatedAvatar, "Avatar Updated successfuly"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, updatedCoverImage, "Cover Image Updated successfuly")
    );
});
...
const getWatchedHstory = asyncHandler(async (req, res) => {
